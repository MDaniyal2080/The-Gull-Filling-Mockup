...
!function(t, e) {
    ...
    var C = {
      ...
      , I = function(t) {
        ...
        i) || "datetime" === l.config.xaxis.type && (d = new M(a).xLabelFormat(l.globals.ttKeyFormatter, d, d, {
            i: void 0,
      ...
      , E = function() {
        ...
        return r(t, [{
            ...
            value: function(t) {
                ...
                if (a && "object" === i(a)) {
                    var l = {};
                    l = -1 !== ["line", "area", "bar", "candlestick", "boxPlot", "rangeBar", "rangeArea", "bubble", "scatter", "heatmap", "treemap", "pie", "polarArea", "donut", "radar", "radialBar"].indexOf(a.chart.type) ? r[a.chart.type]() : r.line(),
            ...
            value: function(t) {
                ...
                if (g.show)
                    for (var u = function(o) {
                        ...
                        "left" === s.config.yaxis[0].labels.align ? (f = g.offsetX,
                        p = "start") : "center" === s.config.yaxis[0].labels.align ? (f = g.offsetX,
                        p = "middle") : "right" === s.config.yaxis[0].labels.align && (p = "end");
                        var x = r.drawText({
                            x: f,
                            y: i + e + g.offsetY - u,
                            text: n,
        ...
        return r(t, [{
            ...
            value: function(t, i, a, s, r) {
                ...
                if (A) {
                    ...
                    this.tooltipUtil.hasBars() && (this.barSeriesHeight = this.tooltipUtil.getBarsHeight(P),
        ...
        return r(t, [{
            ...
            value: function(t) {
                ...
                if (h.globals.isXNumeric) {
                    ...
                    h.globals.seriesX[f][g] && (i = (h.globals.seriesX[f][g] - h.globals.minX) / this.xRatio - r * this.seriesLen / 2)
                }
